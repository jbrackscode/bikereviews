...
export const metadata = {
  ...
  description:
    "We compared six of the most popular vertical bike racks available in Australia.",
};
...
export default function Home() {
  return (
    <>
      ...
      >
        The Bike Rack Buyer&apos;s Guide — Australian Review · {new Date().getFullYear()}
      </div>
      ...
      <section className="py-16 px-6" style={{ background: "var(--white)", borderBottom: "3px solid var(--brand)" }}>
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            <br />
            <em style={{ fontStyle: "italic", color: "var(--brand)" }}>A Practical Guide</em>{" "}
            for Families Transporting Multiple Bikes
          </h1>
